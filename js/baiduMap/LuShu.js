...
//			}
	...
	CustomOverlay.prototype.initialize = function(map) {
		/*var div = this._div = baidu.dom.create('div', {
			style: 'width:auto;min-width:50px;position:absolute;background:#fff;color:#000;font-size:12px;border-radius: 10px;padding:5px;white-space: nowrap;box-shadow:0px 0px 10px #CCCCCC'
		});*/
		...
		map.addEventListener('touchend',function(e){
			...
			if(className =="InfoWindowHtml" || className =="head-box" ||className =="stop-time-box"||className =="stop-place"||className =="stop-time"){
				div.style.visibility = 'hidden';
			}
		});
